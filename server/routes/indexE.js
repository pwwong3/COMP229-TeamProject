...
/* GET Route for dispalying the Update User page. */
router.get('/updateUser', indexController.displayUpdateUserPage);

/* POST Route for dispalying the Update User page. */
